...
public class Collider_pencil : MonoBehaviour
{
    float delayTime = 0f;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "pencil_slot")
        {
            ...
            item_to_spawn = Resources.Load("pencil - Copy") as GameObject;
            Destroy(gameObject);
    ...
    IEnumerator DelayAction(float delayTime)
    {
        ...
        //Destroy(gameObject);
        Debug.Log("pencil is placed in correct slot");
    }
}