...
public class Collider_chair : MonoBehaviour
{
    float delayTime = 0f;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "chair_slot")
        {
            ...
            item_to_spawn = Resources.Load("chair - Copy") as GameObject;
            Destroy(gameObject);
    ...
    IEnumerator DelayAction(float delayTime)
    {
        ...
        //Destroy(gameObject);
        Debug.Log("chair is placed in correct slot");
    }
}
