...
public class Collider_glasses : MonoBehaviour
{
    float delayTime = 0f;
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        if (collision.tag == "glasses_slot")
        {
            ...
            item_to_spawn = Resources.Load("glasses - Copy") as GameObject;
            Destroy(gameObject);
    ...
    IEnumerator DelayAction(float delayTime)
    {
        ...
        //Destroy(gameObject);
        Debug.Log("Glasses is placed in correct slot");
    }
}
